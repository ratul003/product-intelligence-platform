      ...
      <nav style={{
        ...
        <div style={{ ...wrap, display: "flex", alignItems: "center", justifyContent: "space-between", height: "58px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", minWidth: 0 }}>
            ...
            <span className="nav-brand-title" style={{ fontSize: "0.88rem", fontWeight: 700, color: "var(--foreground)", letterSpacing: "-0.01em", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>
              Product Intelligence Platform
            </span>
          </div>
          <div className="nav-brand-author" style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: "2px" }}>
